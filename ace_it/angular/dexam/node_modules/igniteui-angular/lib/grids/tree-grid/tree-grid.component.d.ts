import { ChangeDetectorRef, ComponentFactoryResolver, ElementRef, IterableDiffers, ViewContainerRef, EventEmitter, NgZone, OnInit, TemplateRef } from '@angular/core';
 ...
 * ```
 */
export declare class IgxTreeGridComponent extends IgxGridBaseComponent implements IGridDataBindable, OnInit {
