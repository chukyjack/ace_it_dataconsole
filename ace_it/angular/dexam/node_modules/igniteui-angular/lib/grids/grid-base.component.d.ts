...
export declare abstract class IgxGridBaseComponent extends DisplayDensityBase implements OnInit, OnDestroy, AfterContentInit, AfterViewInit {
 ...
 */
    ...
    */
     ...
     * @hidden
     */
    readonly headerCheckboxWidth: any;
    /**
     * @hidden
     */
    ...
    getNextCell(currRowIndex: number, curVisibleColIndex: number, callback?: (IgxColumnComponent: any) => boolean): {
        rowIndex: number;
        visibleColumnIndex: number;
    };
    getPreviousCell(currRowIndex: number, curVisibleColIndex: number, callback?: (IgxColumnComponent: any) => boolean): {
        rowIndex: number;
        visibleColumnIndex: number;
    };
