...
import { QueryList, AfterContentInit, TemplateRef, ElementRef, ChangeDetectorRef } from '@angular/core';
 ...
 * ```
 */
export declare class IgxSelectComponent extends IgxDropDownComponent implements IgxSelectBase, ControlValueAccessor, AfterContentInit, EditorProvider {
